...
An RDBMS is a Relational Database Management System where data is stored and organized, and SQL is a query language used within an RDBMS to get that data.

1. Why do tables need a `primary key`?  

Tables need a primary key to have a unique identifier that allows us to quickly and accurately select data.
...
In a many to many relationship we would need a third table to join the two.
